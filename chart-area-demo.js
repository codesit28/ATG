...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 50,
      pointBorderWidth: 2,
      data: [0.02, 0.03, 0.05, 0.07, 0.11, 0.05, 0.06, 0.13, 0.09, 0.10, 0.14, 0.16, 0.10, 0.20, 0.20, 0.20, 0.15, 0.20, 0.26, 0.31, 0.24, 0.28, 0.35, 0.38, 0.29, 0.34, 0.41, 0.45, 0.51, 0.56, 0.55, 0.54, 0.59, 0.60, 0.61, 0.59, 0.27, 0.88, 0.72, 0.73, 0.89, 0.92, 0.95, 0.97, 0.99, 0.94, 0.96, 0.97, 0.90, 0.92],
    }],
  },
  options: {
    scales: {
